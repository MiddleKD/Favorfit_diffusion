...
def generate(
    ...
    **kwargs
    ...
    ORIGIN_WIDTH, ORIGIN_HEIGHTS, WIDTH, HEIGHT, LATENTS_WIDTH, LATENTS_HEIGHT = prepare_latent_width_height([input_image])
    ...
    with torch.no_grad():
        ...
        # LOOP start
        timesteps = tqdm(sampler.timesteps[:10], leave=leave_tqdm)
