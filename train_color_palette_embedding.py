...
from embedding.extract_features import get_features
...
def load_models(args):
    ...
    if args.controlnet == True:
        from model_loader import load_controlnet_model
    ...
    if args.color_palette_embedding == True:
        from model_loader import load_color_palette_embedding_model
...
import wandb
from pipeline import generate_color_palette_embedding
...
def main(args):
    ...
    from lora import extract_lora_from_unet
