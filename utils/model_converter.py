...
# HS diffusion main => FavorfitDiffusion main
def convert_model(statedict):
    original_model = statedict
...
# HS controlnet model => Favorfit diffusion controlnet
def convert_controlnet_model(state_dict):
    converted = {}
    converted['controlnet'] = {}
    converted['embedding'] = {}

    converted['controlnet']['encoders.0.0.weight'] = state_dict['control_model.input_blocks.0.0.weight']
    converted['controlnet']['encoders.0.0.bias'] = state_dict['control_model.input_blocks.0.0.bias']
    converted['controlnet']['encoders.1.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.1.0.in_layers.0.weight']
    converted['controlnet']['encoders.1.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.1.0.in_layers.0.bias']
    converted['controlnet']['encoders.1.0.conv_feature.weight'] = state_dict['control_model.input_blocks.1.0.in_layers.2.weight']
    converted['controlnet']['encoders.1.0.conv_feature.bias'] = state_dict['control_model.input_blocks.1.0.in_layers.2.bias']
    converted['controlnet']['encoders.1.0.linear_time.weight'] = state_dict['control_model.input_blocks.1.0.emb_layers.1.weight']
    converted['controlnet']['encoders.1.0.linear_time.bias'] = state_dict['control_model.input_blocks.1.0.emb_layers.1.bias']
    converted['controlnet']['encoders.1.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.1.0.out_layers.0.weight']
    converted['controlnet']['encoders.1.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.1.0.out_layers.0.bias']
    converted['controlnet']['encoders.1.0.conv_merged.weight'] = state_dict['control_model.input_blocks.1.0.out_layers.3.weight']
    converted['controlnet']['encoders.1.0.conv_merged.bias'] = state_dict['control_model.input_blocks.1.0.out_layers.3.bias']
    converted['controlnet']['encoders.1.1.groupnorm.weight'] = state_dict['control_model.input_blocks.1.1.norm.weight']
    converted['controlnet']['encoders.1.1.groupnorm.bias'] = state_dict['control_model.input_blocks.1.1.norm.bias']
    converted['controlnet']['encoders.1.1.conv_input.weight'] = state_dict['control_model.input_blocks.1.1.proj_in.weight']
    converted['controlnet']['encoders.1.1.conv_input.bias'] = state_dict['control_model.input_blocks.1.1.proj_in.bias']
    converted['controlnet']['encoders.1.1.attention_1.out_proj.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['encoders.1.1.attention_1.out_proj.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['encoders.1.1.linear_geglu_1.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['encoders.1.1.linear_geglu_1.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['encoders.1.1.linear_geglu_2.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['encoders.1.1.linear_geglu_2.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['encoders.1.1.attention_2.q_proj.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['encoders.1.1.attention_2.k_proj.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['encoders.1.1.attention_2.v_proj.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['encoders.1.1.attention_2.out_proj.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['encoders.1.1.attention_2.out_proj.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['encoders.1.1.layernorm_1.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['encoders.1.1.layernorm_1.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['encoders.1.1.layernorm_2.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['encoders.1.1.layernorm_2.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['encoders.1.1.layernorm_3.weight'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['encoders.1.1.layernorm_3.bias'] = state_dict['control_model.input_blocks.1.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['encoders.1.1.conv_output.weight'] = state_dict['control_model.input_blocks.1.1.proj_out.weight']
    converted['controlnet']['encoders.1.1.conv_output.bias'] = state_dict['control_model.input_blocks.1.1.proj_out.bias']
    converted['controlnet']['encoders.2.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.2.0.in_layers.0.weight']
    converted['controlnet']['encoders.2.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.2.0.in_layers.0.bias']
    converted['controlnet']['encoders.2.0.conv_feature.weight'] = state_dict['control_model.input_blocks.2.0.in_layers.2.weight']
    converted['controlnet']['encoders.2.0.conv_feature.bias'] = state_dict['control_model.input_blocks.2.0.in_layers.2.bias']
    converted['controlnet']['encoders.2.0.linear_time.weight'] = state_dict['control_model.input_blocks.2.0.emb_layers.1.weight']
    converted['controlnet']['encoders.2.0.linear_time.bias'] = state_dict['control_model.input_blocks.2.0.emb_layers.1.bias']
    converted['controlnet']['encoders.2.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.2.0.out_layers.0.weight']
    converted['controlnet']['encoders.2.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.2.0.out_layers.0.bias']
    converted['controlnet']['encoders.2.0.conv_merged.weight'] = state_dict['control_model.input_blocks.2.0.out_layers.3.weight']
    converted['controlnet']['encoders.2.0.conv_merged.bias'] = state_dict['control_model.input_blocks.2.0.out_layers.3.bias']
    converted['controlnet']['encoders.2.1.groupnorm.weight'] = state_dict['control_model.input_blocks.2.1.norm.weight']
    converted['controlnet']['encoders.2.1.groupnorm.bias'] = state_dict['control_model.input_blocks.2.1.norm.bias']
    converted['controlnet']['encoders.2.1.conv_input.weight'] = state_dict['control_model.input_blocks.2.1.proj_in.weight']
    converted['controlnet']['encoders.2.1.conv_input.bias'] = state_dict['control_model.input_blocks.2.1.proj_in.bias']
    converted['controlnet']['encoders.2.1.attention_1.out_proj.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['encoders.2.1.attention_1.out_proj.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['encoders.2.1.linear_geglu_1.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['encoders.2.1.linear_geglu_1.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['encoders.2.1.linear_geglu_2.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['encoders.2.1.linear_geglu_2.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['encoders.2.1.attention_2.q_proj.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['encoders.2.1.attention_2.k_proj.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['encoders.2.1.attention_2.v_proj.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['encoders.2.1.attention_2.out_proj.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['encoders.2.1.attention_2.out_proj.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['encoders.2.1.layernorm_1.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['encoders.2.1.layernorm_1.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['encoders.2.1.layernorm_2.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['encoders.2.1.layernorm_2.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['encoders.2.1.layernorm_3.weight'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['encoders.2.1.layernorm_3.bias'] = state_dict['control_model.input_blocks.2.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['encoders.2.1.conv_output.weight'] = state_dict['control_model.input_blocks.2.1.proj_out.weight']
    converted['controlnet']['encoders.2.1.conv_output.bias'] = state_dict['control_model.input_blocks.2.1.proj_out.bias']
    converted['controlnet']['encoders.3.0.weight'] = state_dict['control_model.input_blocks.3.0.op.weight']
    converted['controlnet']['encoders.3.0.bias'] = state_dict['control_model.input_blocks.3.0.op.bias']
    converted['controlnet']['encoders.4.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.4.0.in_layers.0.weight']
    converted['controlnet']['encoders.4.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.4.0.in_layers.0.bias']
    converted['controlnet']['encoders.4.0.conv_feature.weight'] = state_dict['control_model.input_blocks.4.0.in_layers.2.weight']
    converted['controlnet']['encoders.4.0.conv_feature.bias'] = state_dict['control_model.input_blocks.4.0.in_layers.2.bias']
    converted['controlnet']['encoders.4.0.linear_time.weight'] = state_dict['control_model.input_blocks.4.0.emb_layers.1.weight']
    converted['controlnet']['encoders.4.0.linear_time.bias'] = state_dict['control_model.input_blocks.4.0.emb_layers.1.bias']
    converted['controlnet']['encoders.4.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.4.0.out_layers.0.weight']
    converted['controlnet']['encoders.4.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.4.0.out_layers.0.bias']
    converted['controlnet']['encoders.4.0.conv_merged.weight'] = state_dict['control_model.input_blocks.4.0.out_layers.3.weight']
    converted['controlnet']['encoders.4.0.conv_merged.bias'] = state_dict['control_model.input_blocks.4.0.out_layers.3.bias']
    converted['controlnet']['encoders.4.0.residual_layer.weight'] = state_dict['control_model.input_blocks.4.0.skip_connection.weight']
    converted['controlnet']['encoders.4.0.residual_layer.bias'] = state_dict['control_model.input_blocks.4.0.skip_connection.bias']
    converted['controlnet']['encoders.4.1.groupnorm.weight'] = state_dict['control_model.input_blocks.4.1.norm.weight']
    converted['controlnet']['encoders.4.1.groupnorm.bias'] = state_dict['control_model.input_blocks.4.1.norm.bias']
    converted['controlnet']['encoders.4.1.conv_input.weight'] = state_dict['control_model.input_blocks.4.1.proj_in.weight']
    converted['controlnet']['encoders.4.1.conv_input.bias'] = state_dict['control_model.input_blocks.4.1.proj_in.bias']
    converted['controlnet']['encoders.4.1.attention_1.out_proj.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['encoders.4.1.attention_1.out_proj.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['encoders.4.1.linear_geglu_1.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['encoders.4.1.linear_geglu_1.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['encoders.4.1.linear_geglu_2.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['encoders.4.1.linear_geglu_2.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['encoders.4.1.attention_2.q_proj.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['encoders.4.1.attention_2.k_proj.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['encoders.4.1.attention_2.v_proj.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['encoders.4.1.attention_2.out_proj.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['encoders.4.1.attention_2.out_proj.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['encoders.4.1.layernorm_1.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['encoders.4.1.layernorm_1.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['encoders.4.1.layernorm_2.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['encoders.4.1.layernorm_2.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['encoders.4.1.layernorm_3.weight'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['encoders.4.1.layernorm_3.bias'] = state_dict['control_model.input_blocks.4.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['encoders.4.1.conv_output.weight'] = state_dict['control_model.input_blocks.4.1.proj_out.weight']
    converted['controlnet']['encoders.4.1.conv_output.bias'] = state_dict['control_model.input_blocks.4.1.proj_out.bias']
    converted['controlnet']['encoders.5.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.5.0.in_layers.0.weight']
    converted['controlnet']['encoders.5.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.5.0.in_layers.0.bias']
    converted['controlnet']['encoders.5.0.conv_feature.weight'] = state_dict['control_model.input_blocks.5.0.in_layers.2.weight']
    converted['controlnet']['encoders.5.0.conv_feature.bias'] = state_dict['control_model.input_blocks.5.0.in_layers.2.bias']
    converted['controlnet']['encoders.5.0.linear_time.weight'] = state_dict['control_model.input_blocks.5.0.emb_layers.1.weight']
    converted['controlnet']['encoders.5.0.linear_time.bias'] = state_dict['control_model.input_blocks.5.0.emb_layers.1.bias']
    converted['controlnet']['encoders.5.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.5.0.out_layers.0.weight']
    converted['controlnet']['encoders.5.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.5.0.out_layers.0.bias']
    converted['controlnet']['encoders.5.0.conv_merged.weight'] = state_dict['control_model.input_blocks.5.0.out_layers.3.weight']
    converted['controlnet']['encoders.5.0.conv_merged.bias'] = state_dict['control_model.input_blocks.5.0.out_layers.3.bias']
    converted['controlnet']['encoders.5.1.groupnorm.weight'] = state_dict['control_model.input_blocks.5.1.norm.weight']
    converted['controlnet']['encoders.5.1.groupnorm.bias'] = state_dict['control_model.input_blocks.5.1.norm.bias']
    converted['controlnet']['encoders.5.1.conv_input.weight'] = state_dict['control_model.input_blocks.5.1.proj_in.weight']
    converted['controlnet']['encoders.5.1.conv_input.bias'] = state_dict['control_model.input_blocks.5.1.proj_in.bias']
    converted['controlnet']['encoders.5.1.attention_1.out_proj.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['encoders.5.1.attention_1.out_proj.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['encoders.5.1.linear_geglu_1.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['encoders.5.1.linear_geglu_1.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['encoders.5.1.linear_geglu_2.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['encoders.5.1.linear_geglu_2.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['encoders.5.1.attention_2.q_proj.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['encoders.5.1.attention_2.k_proj.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['encoders.5.1.attention_2.v_proj.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['encoders.5.1.attention_2.out_proj.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['encoders.5.1.attention_2.out_proj.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['encoders.5.1.layernorm_1.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['encoders.5.1.layernorm_1.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['encoders.5.1.layernorm_2.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['encoders.5.1.layernorm_2.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['encoders.5.1.layernorm_3.weight'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['encoders.5.1.layernorm_3.bias'] = state_dict['control_model.input_blocks.5.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['encoders.5.1.conv_output.weight'] = state_dict['control_model.input_blocks.5.1.proj_out.weight']
    converted['controlnet']['encoders.5.1.conv_output.bias'] = state_dict['control_model.input_blocks.5.1.proj_out.bias']
    converted['controlnet']['encoders.6.0.weight'] = state_dict['control_model.input_blocks.6.0.op.weight']
    converted['controlnet']['encoders.6.0.bias'] = state_dict['control_model.input_blocks.6.0.op.bias']
    converted['controlnet']['encoders.7.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.7.0.in_layers.0.weight']
    converted['controlnet']['encoders.7.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.7.0.in_layers.0.bias']
    converted['controlnet']['encoders.7.0.conv_feature.weight'] = state_dict['control_model.input_blocks.7.0.in_layers.2.weight']
    converted['controlnet']['encoders.7.0.conv_feature.bias'] = state_dict['control_model.input_blocks.7.0.in_layers.2.bias']
    converted['controlnet']['encoders.7.0.linear_time.weight'] = state_dict['control_model.input_blocks.7.0.emb_layers.1.weight']
    converted['controlnet']['encoders.7.0.linear_time.bias'] = state_dict['control_model.input_blocks.7.0.emb_layers.1.bias']
    converted['controlnet']['encoders.7.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.7.0.out_layers.0.weight']
    converted['controlnet']['encoders.7.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.7.0.out_layers.0.bias']
    converted['controlnet']['encoders.7.0.conv_merged.weight'] = state_dict['control_model.input_blocks.7.0.out_layers.3.weight']
    converted['controlnet']['encoders.7.0.conv_merged.bias'] = state_dict['control_model.input_blocks.7.0.out_layers.3.bias']
    converted['controlnet']['encoders.7.0.residual_layer.weight'] = state_dict['control_model.input_blocks.7.0.skip_connection.weight']
    converted['controlnet']['encoders.7.0.residual_layer.bias'] = state_dict['control_model.input_blocks.7.0.skip_connection.bias']
    converted['controlnet']['encoders.7.1.groupnorm.weight'] = state_dict['control_model.input_blocks.7.1.norm.weight']
    converted['controlnet']['encoders.7.1.groupnorm.bias'] = state_dict['control_model.input_blocks.7.1.norm.bias']
    converted['controlnet']['encoders.7.1.conv_input.weight'] = state_dict['control_model.input_blocks.7.1.proj_in.weight']
    converted['controlnet']['encoders.7.1.conv_input.bias'] = state_dict['control_model.input_blocks.7.1.proj_in.bias']
    converted['controlnet']['encoders.7.1.attention_1.out_proj.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['encoders.7.1.attention_1.out_proj.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['encoders.7.1.linear_geglu_1.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['encoders.7.1.linear_geglu_1.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['encoders.7.1.linear_geglu_2.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['encoders.7.1.linear_geglu_2.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['encoders.7.1.attention_2.q_proj.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['encoders.7.1.attention_2.k_proj.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['encoders.7.1.attention_2.v_proj.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['encoders.7.1.attention_2.out_proj.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['encoders.7.1.attention_2.out_proj.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['encoders.7.1.layernorm_1.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['encoders.7.1.layernorm_1.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['encoders.7.1.layernorm_2.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['encoders.7.1.layernorm_2.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['encoders.7.1.layernorm_3.weight'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['encoders.7.1.layernorm_3.bias'] = state_dict['control_model.input_blocks.7.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['encoders.7.1.conv_output.weight'] = state_dict['control_model.input_blocks.7.1.proj_out.weight']
    converted['controlnet']['encoders.7.1.conv_output.bias'] = state_dict['control_model.input_blocks.7.1.proj_out.bias']
    converted['controlnet']['encoders.8.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.8.0.in_layers.0.weight']
    converted['controlnet']['encoders.8.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.8.0.in_layers.0.bias']
    converted['controlnet']['encoders.8.0.conv_feature.weight'] = state_dict['control_model.input_blocks.8.0.in_layers.2.weight']
    converted['controlnet']['encoders.8.0.conv_feature.bias'] = state_dict['control_model.input_blocks.8.0.in_layers.2.bias']
    converted['controlnet']['encoders.8.0.linear_time.weight'] = state_dict['control_model.input_blocks.8.0.emb_layers.1.weight']
    converted['controlnet']['encoders.8.0.linear_time.bias'] = state_dict['control_model.input_blocks.8.0.emb_layers.1.bias']
    converted['controlnet']['encoders.8.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.8.0.out_layers.0.weight']
    converted['controlnet']['encoders.8.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.8.0.out_layers.0.bias']
    converted['controlnet']['encoders.8.0.conv_merged.weight'] = state_dict['control_model.input_blocks.8.0.out_layers.3.weight']
    converted['controlnet']['encoders.8.0.conv_merged.bias'] = state_dict['control_model.input_blocks.8.0.out_layers.3.bias']
    converted['controlnet']['encoders.8.1.groupnorm.weight'] = state_dict['control_model.input_blocks.8.1.norm.weight']
    converted['controlnet']['encoders.8.1.groupnorm.bias'] = state_dict['control_model.input_blocks.8.1.norm.bias']
    converted['controlnet']['encoders.8.1.conv_input.weight'] = state_dict['control_model.input_blocks.8.1.proj_in.weight']
    converted['controlnet']['encoders.8.1.conv_input.bias'] = state_dict['control_model.input_blocks.8.1.proj_in.bias']
    converted['controlnet']['encoders.8.1.attention_1.out_proj.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['encoders.8.1.attention_1.out_proj.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['encoders.8.1.linear_geglu_1.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['encoders.8.1.linear_geglu_1.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['encoders.8.1.linear_geglu_2.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['encoders.8.1.linear_geglu_2.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['encoders.8.1.attention_2.q_proj.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['encoders.8.1.attention_2.k_proj.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['encoders.8.1.attention_2.v_proj.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['encoders.8.1.attention_2.out_proj.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['encoders.8.1.attention_2.out_proj.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['encoders.8.1.layernorm_1.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['encoders.8.1.layernorm_1.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['encoders.8.1.layernorm_2.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['encoders.8.1.layernorm_2.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['encoders.8.1.layernorm_3.weight'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['encoders.8.1.layernorm_3.bias'] = state_dict['control_model.input_blocks.8.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['encoders.8.1.conv_output.weight'] = state_dict['control_model.input_blocks.8.1.proj_out.weight']
    converted['controlnet']['encoders.8.1.conv_output.bias'] = state_dict['control_model.input_blocks.8.1.proj_out.bias']
    converted['controlnet']['encoders.9.0.weight'] = state_dict['control_model.input_blocks.9.0.op.weight']
    converted['controlnet']['encoders.9.0.bias'] = state_dict['control_model.input_blocks.9.0.op.bias']
    converted['controlnet']['encoders.10.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.10.0.in_layers.0.weight']
    converted['controlnet']['encoders.10.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.10.0.in_layers.0.bias']
    converted['controlnet']['encoders.10.0.conv_feature.weight'] = state_dict['control_model.input_blocks.10.0.in_layers.2.weight']
    converted['controlnet']['encoders.10.0.conv_feature.bias'] = state_dict['control_model.input_blocks.10.0.in_layers.2.bias']
    converted['controlnet']['encoders.10.0.linear_time.weight'] = state_dict['control_model.input_blocks.10.0.emb_layers.1.weight']
    converted['controlnet']['encoders.10.0.linear_time.bias'] = state_dict['control_model.input_blocks.10.0.emb_layers.1.bias']
    converted['controlnet']['encoders.10.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.10.0.out_layers.0.weight']
    converted['controlnet']['encoders.10.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.10.0.out_layers.0.bias']
    converted['controlnet']['encoders.10.0.conv_merged.weight'] = state_dict['control_model.input_blocks.10.0.out_layers.3.weight']
    converted['controlnet']['encoders.10.0.conv_merged.bias'] = state_dict['control_model.input_blocks.10.0.out_layers.3.bias']
    converted['controlnet']['encoders.11.0.groupnorm_feature.weight'] = state_dict['control_model.input_blocks.11.0.in_layers.0.weight']
    converted['controlnet']['encoders.11.0.groupnorm_feature.bias'] = state_dict['control_model.input_blocks.11.0.in_layers.0.bias']
    converted['controlnet']['encoders.11.0.conv_feature.weight'] = state_dict['control_model.input_blocks.11.0.in_layers.2.weight']
    converted['controlnet']['encoders.11.0.conv_feature.bias'] = state_dict['control_model.input_blocks.11.0.in_layers.2.bias']
    converted['controlnet']['encoders.11.0.linear_time.weight'] = state_dict['control_model.input_blocks.11.0.emb_layers.1.weight']
    converted['controlnet']['encoders.11.0.linear_time.bias'] = state_dict['control_model.input_blocks.11.0.emb_layers.1.bias']
    converted['controlnet']['encoders.11.0.groupnorm_merged.weight'] = state_dict['control_model.input_blocks.11.0.out_layers.0.weight']
    converted['controlnet']['encoders.11.0.groupnorm_merged.bias'] = state_dict['control_model.input_blocks.11.0.out_layers.0.bias']
    converted['controlnet']['encoders.11.0.conv_merged.weight'] = state_dict['control_model.input_blocks.11.0.out_layers.3.weight']
    converted['controlnet']['encoders.11.0.conv_merged.bias'] = state_dict['control_model.input_blocks.11.0.out_layers.3.bias']
    converted['controlnet']['bottleneck.0.groupnorm_feature.weight'] = state_dict['control_model.middle_block.0.in_layers.0.weight']
    converted['controlnet']['bottleneck.0.groupnorm_feature.bias'] = state_dict['control_model.middle_block.0.in_layers.0.bias']
    converted['controlnet']['bottleneck.0.conv_feature.weight'] = state_dict['control_model.middle_block.0.in_layers.2.weight']
    converted['controlnet']['bottleneck.0.conv_feature.bias'] = state_dict['control_model.middle_block.0.in_layers.2.bias']
    converted['controlnet']['bottleneck.0.linear_time.weight'] = state_dict['control_model.middle_block.0.emb_layers.1.weight']
    converted['controlnet']['bottleneck.0.linear_time.bias'] = state_dict['control_model.middle_block.0.emb_layers.1.bias']
    converted['controlnet']['bottleneck.0.groupnorm_merged.weight'] = state_dict['control_model.middle_block.0.out_layers.0.weight']
    converted['controlnet']['bottleneck.0.groupnorm_merged.bias'] = state_dict['control_model.middle_block.0.out_layers.0.bias']
    converted['controlnet']['bottleneck.0.conv_merged.weight'] = state_dict['control_model.middle_block.0.out_layers.3.weight']
    converted['controlnet']['bottleneck.0.conv_merged.bias'] = state_dict['control_model.middle_block.0.out_layers.3.bias']
    converted['controlnet']['bottleneck.1.groupnorm.weight'] = state_dict['control_model.middle_block.1.norm.weight']
    converted['controlnet']['bottleneck.1.groupnorm.bias'] = state_dict['control_model.middle_block.1.norm.bias']
    converted['controlnet']['bottleneck.1.conv_input.weight'] = state_dict['control_model.middle_block.1.proj_in.weight']
    converted['controlnet']['bottleneck.1.conv_input.bias'] = state_dict['control_model.middle_block.1.proj_in.bias']
    converted['controlnet']['bottleneck.1.attention_1.out_proj.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn1.to_out.0.weight']
    converted['controlnet']['bottleneck.1.attention_1.out_proj.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn1.to_out.0.bias']
    converted['controlnet']['bottleneck.1.linear_geglu_1.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.ff.net.0.proj.weight']
    converted['controlnet']['bottleneck.1.linear_geglu_1.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.ff.net.0.proj.bias']
    converted['controlnet']['bottleneck.1.linear_geglu_2.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.ff.net.2.weight']
    converted['controlnet']['bottleneck.1.linear_geglu_2.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.ff.net.2.bias']
    converted['controlnet']['bottleneck.1.attention_2.q_proj.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn2.to_q.weight']
    converted['controlnet']['bottleneck.1.attention_2.k_proj.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn2.to_k.weight']
    converted['controlnet']['bottleneck.1.attention_2.v_proj.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn2.to_v.weight']
    converted['controlnet']['bottleneck.1.attention_2.out_proj.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn2.to_out.0.weight']
    converted['controlnet']['bottleneck.1.attention_2.out_proj.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.attn2.to_out.0.bias']
    converted['controlnet']['bottleneck.1.layernorm_1.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.norm1.weight']
    converted['controlnet']['bottleneck.1.layernorm_1.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.norm1.bias']
    converted['controlnet']['bottleneck.1.layernorm_2.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.norm2.weight']
    converted['controlnet']['bottleneck.1.layernorm_2.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.norm2.bias']
    converted['controlnet']['bottleneck.1.layernorm_3.weight'] = state_dict['control_model.middle_block.1.transformer_blocks.0.norm3.weight']
    converted['controlnet']['bottleneck.1.layernorm_3.bias'] = state_dict['control_model.middle_block.1.transformer_blocks.0.norm3.bias']
    converted['controlnet']['bottleneck.1.conv_output.weight'] = state_dict['control_model.middle_block.1.proj_out.weight']
    converted['controlnet']['bottleneck.1.conv_output.bias'] = state_dict['control_model.middle_block.1.proj_out.bias']
    converted['controlnet']['bottleneck.2.groupnorm_feature.weight'] = state_dict['control_model.middle_block.2.in_layers.0.weight']
    converted['controlnet']['bottleneck.2.groupnorm_feature.bias'] = state_dict['control_model.middle_block.2.in_layers.0.bias']
    converted['controlnet']['bottleneck.2.conv_feature.weight'] = state_dict['control_model.middle_block.2.in_layers.2.weight']
    converted['controlnet']['bottleneck.2.conv_feature.bias'] = state_dict['control_model.middle_block.2.in_layers.2.bias']
    converted['controlnet']['bottleneck.2.linear_time.weight'] = state_dict['control_model.middle_block.2.emb_layers.1.weight']
    converted['controlnet']['bottleneck.2.linear_time.bias'] = state_dict['control_model.middle_block.2.emb_layers.1.bias']
    converted['controlnet']['bottleneck.2.groupnorm_merged.weight'] = state_dict['control_model.middle_block.2.out_layers.0.weight']
    converted['controlnet']['bottleneck.2.groupnorm_merged.bias'] = state_dict['control_model.middle_block.2.out_layers.0.bias']
    converted['controlnet']['bottleneck.2.conv_merged.weight'] = state_dict['control_model.middle_block.2.out_layers.3.weight']
    converted['controlnet']['bottleneck.2.conv_merged.bias'] = state_dict['control_model.middle_block.2.out_layers.3.bias']

    converted['controlnet']['encoders.1.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.input_blocks.1.1.transformer_blocks.0.attn1.to_v.weight']), 0)
    converted['controlnet']['encoders.2.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.input_blocks.2.1.transformer_blocks.0.attn1.to_v.weight']), 0)
    converted['controlnet']['encoders.4.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.input_blocks.4.1.transformer_blocks.0.attn1.to_v.weight']), 0)
    converted['controlnet']['encoders.5.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.input_blocks.5.1.transformer_blocks.0.attn1.to_v.weight']), 0)
    converted['controlnet']['encoders.7.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.input_blocks.7.1.transformer_blocks.0.attn1.to_v.weight']), 0)
    converted['controlnet']['encoders.8.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.input_blocks.8.1.transformer_blocks.0.attn1.to_v.weight']), 0)
    converted['controlnet']['bottleneck.1.attention_1.in_proj.weight'] = torch.cat((state_dict['control_model.middle_block.1.transformer_blocks.0.attn1.to_q.weight'], state_dict['control_model.middle_block.1.transformer_blocks.0.attn1.to_k.weight'], state_dict['control_model.middle_block.1.transformer_blocks.0.attn1.to_v.weight']), 0)

    converted['controlnet']["bottleneck_out.weight"] =  state_dict["control_model.middle_block_out.0.weight"]
    converted['controlnet']["bottleneck_out.bias"] = state_dict["control_model.middle_block_out.0.bias"]
    converted['controlnet']["zero_convs.0.weight"] = state_dict["control_model.zero_convs.0.0.weight"]
    converted['controlnet']["zero_convs.0.bias"] = state_dict["control_model.zero_convs.0.0.bias"]
    converted['controlnet']["zero_convs.1.weight"] = state_dict["control_model.zero_convs.1.0.weight"]
    converted['controlnet']["zero_convs.1.bias"] = state_dict["control_model.zero_convs.1.0.bias"]
    converted['controlnet']["zero_convs.2.weight"] = state_dict["control_model.zero_convs.2.0.weight"]
    converted['controlnet']["zero_convs.2.bias"] = state_dict["control_model.zero_convs.2.0.bias"]
    converted['controlnet']["zero_convs.3.weight"] = state_dict["control_model.zero_convs.3.0.weight"]
    converted['controlnet']["zero_convs.3.bias"] = state_dict["control_model.zero_convs.3.0.bias"]
    converted['controlnet']["zero_convs.4.weight"] = state_dict["control_model.zero_convs.4.0.weight"]
    converted['controlnet']["zero_convs.4.bias"] = state_dict["control_model.zero_convs.4.0.bias"]
    converted['controlnet']["zero_convs.5.weight"] = state_dict["control_model.zero_convs.5.0.weight"]
    converted['controlnet']["zero_convs.5.bias"] = state_dict["control_model.zero_convs.5.0.bias"]
    converted['controlnet']["zero_convs.6.weight"] = state_dict["control_model.zero_convs.6.0.weight"]
    converted['controlnet']["zero_convs.6.bias"] = state_dict["control_model.zero_convs.6.0.bias"]
    converted['controlnet']["zero_convs.7.weight"] = state_dict["control_model.zero_convs.7.0.weight"]
    converted['controlnet']["zero_convs.7.bias"] = state_dict["control_model.zero_convs.7.0.bias"]
    converted['controlnet']["zero_convs.8.weight"] = state_dict["control_model.zero_convs.8.0.weight"]
    converted['controlnet']["zero_convs.8.bias"] = state_dict["control_model.zero_convs.8.0.bias"]
    converted['controlnet']["zero_convs.9.weight"] = state_dict["control_model.zero_convs.9.0.weight"]
    converted['controlnet']["zero_convs.9.bias"] = state_dict["control_model.zero_convs.9.0.bias"]
    converted['controlnet']["zero_convs.10.weight"] = state_dict["control_model.zero_convs.10.0.weight"]
    converted['controlnet']["zero_convs.10.bias"] = state_dict["control_model.zero_convs.10.0.bias"]
    converted['controlnet']["zero_convs.11.weight"] = state_dict["control_model.zero_convs.11.0.weight"]
    converted['controlnet']["zero_convs.11.bias"] = state_dict["control_model.zero_convs.11.0.bias"]
    converted['controlnet']['time_embed.linear_1.weight'] = state_dict['control_model.time_embed.0.weight']
    converted['controlnet']['time_embed.linear_1.bias'] = state_dict['control_model.time_embed.0.bias']
    converted['controlnet']['time_embed.linear_2.weight'] = state_dict['control_model.time_embed.2.weight']
    converted['controlnet']['time_embed.linear_2.bias'] = state_dict['control_model.time_embed.2.bias']

    converted['embedding']['conv_in.weight'] = state_dict["control_model.input_hint_block.0.weight"]
    converted['embedding']['conv_in.bias'] = state_dict["control_model.input_hint_block.0.bias"]
    converted['embedding']['blocks.0.weight'] = state_dict["control_model.input_hint_block.2.weight"]
    converted['embedding']['blocks.0.bias'] = state_dict["control_model.input_hint_block.2.bias"]
    converted['embedding']['blocks.1.weight'] = state_dict["control_model.input_hint_block.4.weight"]
    converted['embedding']['blocks.1.bias'] = state_dict["control_model.input_hint_block.4.bias"]
    converted['embedding']['blocks.2.weight'] = state_dict["control_model.input_hint_block.6.weight"]
    converted['embedding']['blocks.2.bias'] = state_dict["control_model.input_hint_block.6.bias"]
    converted['embedding']['blocks.3.weight'] = state_dict["control_model.input_hint_block.8.weight"]
    converted['embedding']['blocks.3.bias'] = state_dict["control_model.input_hint_block.8.bias"]
    converted['embedding']['blocks.4.weight'] = state_dict["control_model.input_hint_block.10.weight"]
    converted['embedding']['blocks.4.bias'] = state_dict["control_model.input_hint_block.10.bias"]
    converted['embedding']['blocks.5.weight'] = state_dict["control_model.input_hint_block.12.weight"]
    converted['embedding']['blocks.5.bias'] = state_dict["control_model.input_hint_block.12.bias"]
    converted['embedding']['conv_out.weight'] = state_dict["control_model.input_hint_block.14.weight"]
    converted['embedding']['conv_out.bias'] = state_dict["control_model.input_hint_block.14.bias"]
        ...
        if ln == "encoders":
            for layer in encoder_layer_map.keys():
                for attn in [1,2]:
                    for t in qkv:
                        for d in ud:
                            weight_map.append(
                                (f"unet.{ln}.{layer}.1.attention_{attn}.{t}_lora_{d}.weight",
            ...
            for attn in [1,2]:
                for t in qkv:
                    for d in ud:
                        weight_map.append(
                            (f"unet.{ln}.1.attention_{attn}.{t}_lora_{d}.weight",
                                f"{lns[ln]}.attentions.0.transformer_blocks.0.attn{attn}.processor.to_{t}_lora.{d}.weight")
                        )

    for key, sd_key in weight_map:
        converted[key] = state_dict[sd_key]
